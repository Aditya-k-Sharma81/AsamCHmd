...
export default function SellerOrdersPage() {
  ...
  // Detailed mathematical conversion breakdown for verification
  const renderVerificationDetails = (item) => {
    ...
    return (
      <div className="bg-neutral-950/80 rounded-xl p-4 border border-neutral-800 text-[11px] font-mono text-neutral-300 space-y-2">
        <div className="flex items-center text-emerald-400 font-bold border-b border-neutral-800 pb-1 mb-1 text-[9px] uppercase tracking-wider">
          Verification Trail
        </div>
        <div>
        ...
        <div className="border-t border-neutral-800 pt-1 text-[10px] flex justify-between items-center text-emerald-300 font-semibold bg-emerald-950/20 px-2 py-1 rounded">
          <span>3. Subtotal:</span>
          <span>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-b border-neutral-800 pb-4">
        ...
        <p className="text-xs text-neutral-400 mt-1">Quotations placed by clients containing your products, with split price calculations.</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-neutral-900/20 border border-dashed border-neutral-850 rounded-2xl">
          <p className="text-neutral-400 text-sm">No quotations have been filed for your products yet.</p>
        </div>
      ) : (
        <div className="space-y-4">
          {quotations.map((quote) => {
            ...
            // Calculate total for this seller's products only
            let sellerTotal = 0;
                ...
                >
                  <div className="space-y-1">
                    ...
                    <p className="text-xs font-semibold text-neutral-300">
                      Customer: <span className="text-neutral-100 font-bold">{quote.user.name}</span>
                    </p>
                  </div>

                  <div className="flex items-center space-x-4">
                    <div className="text-right">
                      <p className="text-[10px] text-neutral-400 font-bold uppercase tracking-wider">My Subtotal</p>
                      <p className="text-lg font-black text-emerald-400">{formatCurrency(sellerTotal)}</p>
                    </div>
                ...
                {isExpanded && (
                  <div className="p-5 border-t border-neutral-850 bg-neutral-950/30 space-y-5 animate-slideDown">
                          ...
                          {quote.items.map((item) => (
                            <tr key={item.id} className="hover:bg-neutral-900/10">
                              <td className="px-4 py-3">
                                ...
                                <span className="font-mono text-[9px] bg-neutral-950 border border-neutral-800 text-neutral-400 px-1 py-0.5 rounded animate-pulse">
                                  {item.product.sku}
                                </span>
                              </td>
                    ...
                    <div className="space-y-3">
                      <h4 className="text-xs font-bold text-neutral-400 uppercase tracking-wider">Conversion & Pricing Audit Details</h4>
